...
static void print_bfiles_options_after(char **names, int file_headers, int pre_number, int argc);
static void print_files_options_after(char **names, int file_headers, int pre_number, int argc);
