...
class InteractiveArea {
    ...
    _drawRectPart() {
        ...
        this.gcontext.fillRect( this.height/2, this.width/2, this.radius / 2, this.radius );
        this.gcontext.strokeRect(this.height/2, this.width/2, this.radius / 2, this.radius );
    }
    ...
    _drawArcPart() {
        ...
        this.gcontext.arc( this.width/2,this.height/2, this.radius / 2, 0.5*Math.PI, Math.PI);
...
function drawAxis( graphicContext, width, height, color = "#000" ) {
