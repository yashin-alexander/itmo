...
class Routes(
  ...
  def documentation = List(
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """add_point""", """controllers.Application.AddPoint(x:Double, y:Double, r:Double)"""),
  ...
  private[this] lazy val controllers_Application_AddPoint0_invoker = createInvoker(
    Application_1.AddPoint(fakeValue[Double], fakeValue[Double], fakeValue[Double]),
  ...
  // @LINE:9
  private[this] lazy val controllers_Application_RemovePoints2_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("remove_points")))
  )
  private[this] lazy val controllers_Application_RemovePoints2_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_Application_AddPoint0_route(params) =>
      call(params.fromQuery[Double]("x", None), params.fromQuery[Double]("y", None), params.fromQuery[Double]("r", None)) { (x, y, r) =>
        controllers_Application_AddPoint0_invoker.call(Application_1.AddPoint(x, y, r))
      }
  
    // @LINE:8
    case controllers_Application_ChangeRadius1_route(params) =>
      call(params.fromQuery[String]("r", None)) { (r) =>
        controllers_Application_ChangeRadius1_invoker.call(Application_1.ChangeRadius(r))
      }
  
    // @LINE:9
    case controllers_Application_RemovePoints2_route(params) =>
      call { 
        controllers_Application_RemovePoints2_invoker.call(Application_1.RemovePoints())
      }
    ...
    case controllers_Application_login3_route(params) =>
      call(params.fromQuery[String]("username", None), params.fromQuery[String]("password", None)) { (username, password) =>
        controllers_Application_login3_invoker.call(Application_1.login(username, password))
      }
  
    // @LINE:12
    case controllers_Application_register4_route(params) =>
      call(params.fromQuery[String]("username", None), params.fromQuery[String]("password", None)) { (username, password) =>
        controllers_Application_register4_invoker.call(Application_1.register(username, password))
      }
  
    // @LINE:14
    case controllers_Application_index5_route(params) =>
      call { 
        controllers_Application_index5_invoker.call(Application_1.index())
      }
